...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryPhi3 = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryPhi3.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel phi3Model , String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryPhi3.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = phi3Model.generate(fewShotHistoryPhi3);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        ChatLanguageModel phi3Model = AiBeans.getChatLanguageModelLlama(AiConstants.OLLAMA_PHI);
        AiBeans.printModelDetails(AiConstants.LLM_OLLAMA, AiConstants.OLLAMA_PHI);

        // Build Chat Context
        buildContext();
        // Message 1
        sendChatMessage(phi3Model, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(phi3Model, "The app is fantastic!");
        // Message 3
        sendChatMessage(phi3Model, "Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(phi3Model, "App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
