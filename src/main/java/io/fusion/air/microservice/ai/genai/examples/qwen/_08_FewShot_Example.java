...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryQwen = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryQwen.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel modelQwen, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryQwen.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = modelQwen.generate(fewShotHistoryQwen);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        buildContext();
        // Message 1
        sendChatMessage(modelQwen, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(modelQwen, "The app is fantastic!");
        // Message 3
        sendChatMessage(modelQwen, "Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(modelQwen, "App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
