...
public class _07_ChatMemory_Example {
    ...
    public static void chatMemoryConversations(ChatLanguageModel geminiChatModel ) {
        Tokenizer tokenizer = new OpenAiTokenizer(AiConstants.GPT_4_TURBO);
        ChatMemory chatMemoryGemini = TokenWindowChatMemory.withMaxTokens(2000, tokenizer);
        ...
        SystemMessage systemMessage = SystemMessage.from(
                """
                        ...
                        """);
        chatMemoryGemini.add(systemMessage);
        ...
        UserMessage userMessage1 = userMessage(
                """
                 ...
                 """);
        chatMemoryGemini.add(userMessage1);
        Response<AiMessage> response1 = geminiChatModel.generate(chatMemoryGemini.messages());
        chatMemoryGemini.add(response1.content());
        // Print Result
        ...
        UserMessage userMessage2 = userMessage(
                ...
                """);
        chatMemoryGemini.add(userMessage2);
        Response<AiMessage> response2 = geminiChatModel.generate(chatMemoryGemini.messages());
        chatMemoryGemini.add(response2.content());
        // Print Result
        AiBeans.printResult(userMessage2.text(), response2.content().text());
    }

    public static void chatMemoryWithMultipleUsers(ChatLanguageModel geminiChatModel ) {
        Assistant assistantGemini = AiServices.builder(Assistant.class)
    ...
    public static void main(String[] args)  {
        ...
        chatMemoryConversations( geminiChatModel );

        // Chat Memory with Multiple user
        chatMemoryWithMultipleUsers( geminiChatModel );
    }
}
