...
public class _09_Translator_Example {
    ...
    public static void main(String[] args) {
        ...
        // Create Ai Assistant
        LanguageAssistant qwenAssistant = AiServices.create(LanguageAssistant.class, modelQwen);
        String request = """
                    Hello, how are you?
                    What do you think about current weather and climate change?
                    Do you think climate change is real?
                """;
        String response = qwenAssistant.translate(request, "french");
        ...
        List<String> bulletPoints = qwenAssistant.summarize(request, 5);
