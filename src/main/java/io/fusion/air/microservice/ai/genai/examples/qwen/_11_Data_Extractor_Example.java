...
public class _11_Data_Extractor_Example {
    ...
    public static void numberExtractor( DataExtractorAssistant qwenDataExtractor) {
        // Extract Numbers
        String request = """
        ...
        int intNumber = qwenDataExtractor.extractInt(request);
        AiBeans.printResult(request, "Number = "+intNumber);
    }

    public static void dateTimeExtractor(DataExtractorAssistant qwenDataExtractor) {
        ...
        LocalDate date = qwenDataExtractor.extractDateFrom(request);
        sb.append("Date      = ").append(date).append("\n");
        LocalTime time = qwenDataExtractor.extractTimeFrom(request);
        sb.append("Time      = ").append(time).append("\n");
        LocalDateTime dateTime = qwenDataExtractor.extractDateTimeFrom(request);
        sb.append("DateTime = ").append(dateTime);

        AiBeans.printResult(request, sb.toString());
    }

    public static void pojoExtractor( DataExtractorAssistant qwenDataExtractor) {
        ...
        Person person = qwenDataExtractor.extractPersonFrom(request);
        AiBeans.printResult(request, person.toString());
    }

    public static void complexPojoExtractor(ChatLanguageModel qwenDataExtractor) {
        ChefAssistant chefAssistant = AiServices.create(ChefAssistant.class, qwenDataExtractor);
    ...
    public static void main(String[] args) {
        ...
        DataExtractorAssistant qwenDataExtractor = AiServices.create(DataExtractorAssistant.class, modelQwen);

        try {
            Std.println("Number Extractor =================================================");
            // Extract Numbers
            numberExtractor(qwenDataExtractor);
        } catch (Exception e) {
        ...
        try {
            ...
            // Extract Date and Time
            dateTimeExtractor(qwenDataExtractor);
        } catch (Exception e) {
            Std.println(ERROR_MESSAGE+e.getMessage());
        }
        try {
            ...
            // POJO Person Extractor
             pojoExtractor(qwenDataExtractor);
        } catch (Exception e) {
            Std.println(ERROR_MESSAGE+e.getMessage());
        }
        try {
            ...
            complexPojoExtractor(modelQwen);
        } catch (Exception e) {
            Std.println(ERROR_MESSAGE+e.getMessage());
        }
    }
