...
public class _51_RAG_Simple_Example {
    ...
    public static void main(String[] args) {
        ...
        ChatLanguageModel modelPhi3 = AiBeans.getChatLanguageModelLlama(AiConstants.OLLAMA_PHI);
        AiBeans.printModelDetails(AiConstants.LLM_OLLAMA, AiConstants.OLLAMA_PHI);
        // Create Assistant
        // Setting up the Gen AI Context with Open AI LLM, and RAG
        Assistant assistant = RAGBuilder.createCarRentalAssistantSimple(modelPhi3);
