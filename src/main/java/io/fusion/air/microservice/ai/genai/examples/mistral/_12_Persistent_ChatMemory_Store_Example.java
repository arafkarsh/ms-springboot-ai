...
public class _12_Persistent_ChatMemory_Store_Example {
    ...
    public static Assistant setupContext(ChatLanguageModel mistralChatModel) {
        // Create Persistent Store
        ChatMemoryFileStore store = new ChatMemoryFileStore();
        // Create Chat Memory Provider with the Store
        ChatMemoryProvider chatMemoryProviderMistral = memoryId -> MessageWindowChatMemory.builder()
                .id(memoryId)
                .maxMessages(10)
        ...
        return AiServices.builder(Assistant.class)
                ...
                .chatMemoryProvider(chatMemoryProviderMistral)
                .build();
    }

    public static void persistInitialData(Assistant assistantMistral ) {
    ...
    public static void testThePersistedData(Assistant assistantMistral ) {
    ...
    public static void main(String[] args) {
        ...
        Assistant assistantMistral = setupContext(mistralChatModel);
        // Initialize with Data
        persistInitialData(assistantMistral);
        ...
        testThePersistedData(assistantMistral);
    }
}
