...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryAnthropic = new ArrayList<>();
    /**
    ...
    public static void buildContext() {
        ...
        fewShotHistoryAnthropic.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel anthropicModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryAnthropic.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = anthropicModel.generate(fewShotHistoryAnthropic);
        // Print Result
    ...
    public static void main(String[] args) {
       ...
       ChatLanguageModel anthropicModel = AiBeans.getChatLanguageModelAnthropic(AiConstants.ANTHROPIC_CLAUDE_3_HAIKU);
        AiBeans.printModelDetails(AiConstants.LLM_ANTHROPIC, AiConstants.ANTHROPIC_CLAUDE_3_HAIKU);
        // Build Chat Context
        buildContext();
        // Message 1
        sendChatMessage(anthropicModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(anthropicModel, "The app is fantastic!");
        // Message 3
        sendChatMessage(anthropicModel, "Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(anthropicModel, "App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
