...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryMistral = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryMistral.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel mistralChatModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryMistral.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = mistralChatModel.generate(fewShotHistoryMistral);
        // Print Result
    ...
    public static void main(String[] args) {
      ...
      // Build Chat Context
        buildContext();
        // Message 1
        sendChatMessage(mistralChatModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(mistralChatModel, "The app is fantastic!");
        // Message 3
        sendChatMessage(mistralChatModel, "Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(mistralChatModel, "App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
