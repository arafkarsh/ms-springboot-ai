...
public class _07_ChatMemory_Example {
    ...
    public static void chatMemoryConversations(ChatLanguageModel anthropicModel) {
        Tokenizer tokenizer = new OpenAiTokenizer(AiConstants.GPT_4_TURBO);
        ChatMemory chatMemoryAnthropic = TokenWindowChatMemory.withMaxTokens(2000, tokenizer);
        ...
        SystemMessage systemMessage = SystemMessage.from(
                """
                        ...
                        """);
        chatMemoryAnthropic.add(systemMessage);
        ...
        UserMessage userMessage1 = userMessage(
                """
                 ...
                 """);
        chatMemoryAnthropic.add(userMessage1);
        Response<AiMessage> response1 = anthropicModel.generate(chatMemoryAnthropic.messages());
        chatMemoryAnthropic.add(response1.content());
        // Print Result
        ...
        UserMessage userMessage2 = userMessage(
                ...
                """);
        chatMemoryAnthropic.add(userMessage2);
        Response<AiMessage> response2 = anthropicModel.generate(chatMemoryAnthropic.messages());
        chatMemoryAnthropic.add(response2.content());
        // Print Result
        AiBeans.printResult(userMessage2.text(), response2.content().text());
        AiBeans.sleep(55);
    }

    public static void chatMemoryWithMultipleUsers(ChatLanguageModel anthropicChatModel) {
        Assistant assistantAnthropic = AiServices.builder(Assistant.class)
    ...
    public static void main(String[] args) {
        ...
        chatMemoryConversations(anthropicChatModel);

        // Chat Memory with Multiple user
        chatMemoryWithMultipleUsers(anthropicChatModel);
    }
}
