...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryGemini = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryGemini.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel geminiModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryGemini.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = geminiModel.generate(fewShotHistoryGemini);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        ChatLanguageModel geminiModel = AiBeans.getChatLanguageModelGoogle(AiConstants.GOOGLE_GEMINI_PRO);
        AiBeans.printModelDetails(AiConstants.LLM_VERTEX, AiConstants.GOOGLE_GEMINI_PRO);
        // Build Chat Context
        buildContext();
        // Message 1
        sendChatMessage(geminiModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(geminiModel,"The app is fantastic!");
        // Message 3
        sendChatMessage(geminiModel,"Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(geminiModel,"App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
