...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryGemma = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryGemma.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel gemmaChatModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryGemma.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = gemmaChatModel.generate(fewShotHistoryGemma);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        buildContext();
        // Message 1
        sendChatMessage(gemmaChatModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(gemmaChatModel, "The app is fantastic!");
        // Message 3
        sendChatMessage(gemmaChatModel, "Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(gemmaChatModel, "App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
