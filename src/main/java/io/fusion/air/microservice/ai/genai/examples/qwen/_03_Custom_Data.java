...
public class _03_Custom_Data {
    ...
    public static void main(String[] args) {
        ...
        String request1 = """
            ...
            """;
        CustomDataAnalyzer.processFile(request1,  "bramayugam.txt", modelQwen);
        ...
        String request2 = """
                ...
                """;
        CustomDataAnalyzer.processFile(request2,  "vaaliban.txt", modelQwen);

        // Multi File Analysis
        CustomDataAnalyzer.processMultiFiles("Malaikotai Vaaliban", modelQwen);
        CustomDataAnalyzer.processMultiFiles("Bramayugam", modelQwen);
