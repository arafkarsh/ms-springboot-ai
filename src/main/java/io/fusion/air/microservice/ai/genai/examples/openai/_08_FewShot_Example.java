...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryChatGPT = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryChatGPT.add(UserMessage
     ...
     * @return
     */
    public static String sendChatMessage(ChatLanguageModel chatGPTModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryChatGPT.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = chatGPTModel.generate(fewShotHistoryChatGPT);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        ChatLanguageModel chatGPTModel = AiBeans.getChatLanguageModelOpenAi(AiConstants.GPT_4o);
        AiBeans.printModelDetails(AiConstants.LLM_OPENAI, AiConstants.GPT_4o);

        // Build Chat Context
        buildContext();
        // Message 1
        sendChatMessage(chatGPTModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(chatGPTModel,"The app is fantastic!");
        // Message 3
        sendChatMessage(chatGPTModel,"Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(chatGPTModel,"App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
