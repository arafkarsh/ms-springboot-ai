...
public class _08_FewShot_Example {
    ...
    private static List<ChatMessage> fewShotHistoryFalcon = new ArrayList<>();
    ...
    public static void buildContext() {
        ...
        fewShotHistoryFalcon.add(UserMessage
     ...
     * @param request
     */
    public static String sendChatMessage(ChatLanguageModel falconChatModel, String request) {
        // Adding user message
        ChatMessage chatMessage = UserMessage.from(request);
        fewShotHistoryFalcon.add(chatMessage);
        // Response from Ai
        Response<AiMessage> response = falconChatModel.generate(fewShotHistoryFalcon);
        // Print Result
    ...
    public static void main(String[] args) {
        ...
        buildContext();
        // Message 1
        sendChatMessage(falconChatModel, "How can your app be so slow? Please do something about it!");
        // Message 2
        sendChatMessage(falconChatModel, "The app is fantastic!");
        // Message 3
        sendChatMessage(falconChatModel,"Simplified my daily tasks! Good work team.");
        // Message 4
        sendChatMessage(falconChatModel,"App Crashes twice or thrice in a week. Stability is not that good.");
    }
}
